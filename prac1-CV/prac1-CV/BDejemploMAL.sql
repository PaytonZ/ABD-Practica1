...
-- ERROR : Cotizacion     INT defaut 99 -> default
-- CHECK          (Capital > 0) -> capitol
--
---------------------------------------------------------------------
...
-- ERROR: (continue, este error se ve mas adelante al insertar filas)
-- 
---------------------------------------------------------------------
...
(NumT   INT,
 ...
 CHECK (NumT <> 0),
 PRIMARY KEY (NumT),
 CHECK (TipoT in ('VXK','COSA','PISSA','PISA'))
 );
-- ERROR1: CHECK TipoT in ('VXK','COSA','PISSA') ->  CHECK (TipoT in ('VXK','COSA','PISSA')) 
-- ERROR2:  CHECK (TipoT in ('VXK','COSA','PISSA','PISA'))
-- ERROR3:  CHECK (NummT <> 0), -> CHECK (NumT <> 0),
---------------------------------------------------------------------
...
-- ERROR1:  FOREIGN KEY (DNI) REFERENCES Cliente(DNO),-> FOREIGN KEY (DNI) REFERENCES Cliente(DNI), 
-- ERROR2:(se ve mas adelante)
---------------------------------------------------------------------
...
-- dejar 'direc 12' para ver otro error interesante después
---------------------------------------------------------------------
...
-- ERROR: INSERT INTO Empresa VALUES ('Empresa 55', 555555, 000000.00); -> CAPITAL > 0

--INSERT INTO Empresa VALUES ('Empresa 11', 111111, 110000.00);

-- ERROR:--INSERT INTO Empresa VALUES ('Empresa 11', 111111, 110000.00); EMPRESA YA CREADA
...
-- ERROR: Modificar primary key
--(modificar la declaracion  de invierte)
...
-- CAMBIADA y addded masterruin y menos ruin
...
--INSERT INTO TieneT VALUES ('00000005', '50000400', 0901, 50000AB);
-- ERROR : caracteres alfanumericos
--	(para continuar comente insert con '--') 
---------------------------------------------------------------------

--INSERT INTO Facturas VALUES ('00000001','911111111111');
